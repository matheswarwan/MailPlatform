...
export default function Sidebar() {
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center gap-2 px-5 py-5 border-b" style={{ borderColor: '#252B3B' }}>
        <div
        ...
        <span className="text-lg font-bold tracking-tight" style={{ color: '#F1F3F9' }}>
